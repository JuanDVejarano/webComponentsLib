...
Se crean los change logs para la documentacion de cada version creada (c378770)
- 2024-08-07 - docs(Global): :construction_worker: Creacion de archivo PY para Chagelogs

Creacion py para change logs (7885612)
- 2024-08-07 - ci(Global): :pushpin: Cambio de patch

Se cambia el patch para el publicar nuevamente en npm (c923937)
- 2024-08-07 - ci(Global): :green_heart: Build para despliegue de react

Se separan los builds de stencil y de react para despliegue con YAML (299fdc7)
- 2024-08-07 - ci(Global): :green_heart: Build global

Se modifica archivo YAML para buildear todos los proyectos por lerna (838021a)
